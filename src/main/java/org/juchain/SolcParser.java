/* SolcParser.java */
/* Generated By:JavaCC: Do not edit this line. SolcParser.java */
import java.io.*;

/**
 * Grammar to parse Solidity version 0.4.20
 * @author shao.lin@live.com
 */
public class SolcParser implements SolcParserConstants {
   /**
   ...
   public SolcParser(String fileName)
   {
      this(System.in);
  ...
  public static void main(String args[]) {
    ...
    if (args.length == 0) {
      ...
      parser = new SolcParser(System.in);
    } else if (args.length == 1) {
      System.out.println("Java Parser Version 1.1:  Reading from file " + args[0] + " . . .");
      try {
        parser = new SolcParser(new java.io.FileInputStream(args[0]));
      ...
      System.out.println("         java SolcParser < inputfile");
...
void AnnotationTypeDeclaration(int modifiers) throws ParseException {
  ...
  private boolean jj_3_28()
 {
    if (jj_3R_80()) return true;
    if (jj_scan_token(DOT)) return true;
    if (jj_scan_token(CONTRACT)) return true;
    return false;
  }
  ...
  private boolean jj_3R_213()
 {
  ...
  public SolcParserTokenManager token_source;
  ...
  public SolcParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public SolcParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new SolcParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  }
  ...
  /** Constructor. */
  public SolcParser(java.io.Reader stream) {
  ...
  public SolcParser(SolcParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
  }
  ...
  /** Reinitialise. */
  public void ReInit(SolcParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
  }
